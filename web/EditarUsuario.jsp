    ...
    <body>
        ...
        <form action="GatilhoEditarUsuario.jsp" method="post">   
            <table style="background-color: transparent;">                
                ...
                <tr style="background-color: transparent; color:black;"><td>Telefone: <input class="text_input" type="tel" pattern="[0-9]{4}[0-9]{4}" placeholder="" name="telefoneUsuario" value="<%=objusuarios.getTelefoneUsuario()%>"/></td></tr>                
