...
<title>SGCO - Alterar Hospital</title>
</head>
<script
...
<body>
	...
	TbHospital hospital = HospitalDao.getRegistroById(Integer.parseInt(id));
	%>
	<header>
	...
	<h2>Alterar Hospital</h2>

	<form action="GatilhoAlterarHospital.jsp" method="post">
		<table style="background-color: transparent">
			<tr>
				<td>ID:</td>
				<td colspan="1"><input type="text" name="idHospital" required
					maxlength="45" value="<%=hospital.getIdHospital()%>"
					readonly="readonly"></td>
			</tr>
			<tr>
				<td>Razão Social:</td>
				<td colspan="3"><input class="text_input" type="text"
					name="razaoSocial" required maxlength="50"
					value="<%=hospital.getRazaoSocial()%>" /></td>
			</tr>
			<tr>
				<td>Nome Fantasia:</td>
				<td colspan="3"><input class="text_input" type="text"
					name="nomeFantasia" required maxlength="50"
					value="<%=hospital.getNomeFantasia()%>" /></td>
			</tr>
			<tr>
				<td>CNPJ:</td>
				<td><input class="text_input" type="text" name="cnpjHospital"
					required maxlength="50" value="<%=hospital.getCnpjHospital()%>"
					readonly="readonly" /></td>
				<td>Telefone:</td>
				<td><input class="text_input" type="text" name="telefone"
					required value="<%=hospital.getTelefone()%>" /></td>
			</tr>
			<tr>
				<td>Email:</td>
				<td colspan="3"><input class="text_input" type="text"
					name="email" required value="<%=hospital.getEmail()%>" /></td>
			</tr>
			<tr>
				<td>Rua:</td>
				<td colspan="3"><input class="text_input" type="text"
					name="rua" required maxlength="50" value="<%=hospital.getRua()%>" /></td>
			</tr>
			<tr>
				<td>Bairro:</td>
				<td colspan="3"><input class="text_input" type="text"
					name="bairro" required maxlength="50"
					value="<%=hospital.getBairro()%>" /></td>
			</tr>
			<tr>
				<td>Cidade:</td>
				<td colspan="3"><input class="text_input" type="text"
					name="cidade" required maxlength="50"
					value="<%=hospital.getCidade()%>" /></td>

			</tr>
			<tr>
				<td>Estado:</td>
				<td><select id="estado" name="estado">
						<option value="<%=hospital.getEstado()%>" selected disabled></option>
