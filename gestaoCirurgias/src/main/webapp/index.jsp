...
<body>
	...
	<main>
		<h1 class="itens-header">SGPO - SISTEMA DE GESTÃO DE PRÓTESES
			ORTOPÉDICAS</h1>
		<a href="ConsultaHospitais.jsp"><button class="btn-principal">
				<img src="./img/hospital.svg" alt="hospital"
					title="Consultar Hospital" />Consulta Hospitais
			</button></a> <a href="NovoAgendamento.jsp"> Novo Agendamento</a> <a
			href="componentes.jsp"> Consultar Componentes</a>
				...
				<c:forEach items="${lista}" var="agendamento">
					...
					<tr style="">
						...
						<td style="background-color: #E1E5F2; border: 0;"><a
							href="EditarAgendamento.jsp?id=${agendamento.getIdAgendamento()}"><img
